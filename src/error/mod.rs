...
/// Error messages for the main compilation stages.
#[macro_use]
pub mod stage;

/// Errors for the preparation stage.
pub mod init;

/// Errors for the assembler stages.
#[macro_use]
pub mod asm;
...
/// Panics with the source context.
...
/// No arguments.
macro_rules! source {
    () => { crate::error::SourceCtx{ file: file!(), line: line!(), column: column!() } }
}
...
impl<'a> ErrCtx<'a> {
    ...
    /// Finds the start of `self.word` relative to `self.line`.
